                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_jenis" id="nama_jenis" class="form-control {{ $errors->has('nama_jenis') ? 'is-invalid':'' }}" placeholder="Masukana Nama Jenis..." value="{{ $dataJenis->FN_JENIS }}" required>
                            <div class="invalid-feedback">
