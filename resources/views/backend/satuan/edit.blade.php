                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_satuan" id="nama_satuan" class="form-control {{ $errors->has('nama_satuan') ? 'is-invalid':'' }}" placeholder="Masukana Nama Satuan..." value="{{ $dataSatuan->FN_SAT }}" required>
                            <div class="invalid-feedback">
